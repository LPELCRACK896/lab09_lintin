/* eslint-disable spaced-comment */const path = require('path');
    ...
    rules: [
      {
        test: /\.scss$/,
        use: [
          MinCssExtractProduction.loader, //3. Extrae Css into files
      ...
      },
      {
        ...
        use: [
          MinCssExtractProduction.loader, //2. Inyecta los estilos al DOM
